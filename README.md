...
The ScrollStats Workflow can be broken up into the 3 major steps listed below. Each of these steps is covered in detail in [docs](docs/) with code examples using datasets generated from [a bend on the Lower Brazos River, TX](https://www.google.com/maps/@30.614411,-96.499508,16z).
